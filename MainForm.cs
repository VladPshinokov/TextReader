...
namespace TextReader
{
    public partial class MainForm : Form
    {
        ...
        {
            richTextBox1.Clear(); // файл уже был закрыт при выполнении функции ReadAllText(), поэтому просто очищаем поле 
        }
        ...
        {
            if (richTextBox1.Text != textSrc) // проверка, менялся ли загруженный в форму файл
            {
